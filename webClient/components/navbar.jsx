    ...
    render() {
        ...
        return (
            <div>
                ...
                style = {
                    styles.linkStyle
                } > <span style={styles.appbarTitleStyle}>Library</span> < /Link>} titleStyle={styles.appbarTitleStyle} iconElementRight={rightIcon} onLeftIconButtonTouchTap={this.toggleNav.bind(this)}/>
                <Drawer open={this.state.openDrawer} containerStyle={styles.drawerStyle} docked={false} onRequestChange={(open) => this.setState({openDrawer: open})}>
                    ...
                    } > Library< /span>} titleStyle={styles.appbarTitleStyle} onLeftIconButtonTouchTap={this.toggleNav.bind(this)}/>
